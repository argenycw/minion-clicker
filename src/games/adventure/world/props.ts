...
export const propDefinitions: Record<WorldObjectKind, PropDefinition> = {
  tree: { kind: 'tree', width: 58, height: 52, blocking: true, maxHp: 86, collision: { kind: 'circle', radiusRatio: 0.34 } },
  bush: { kind: 'bush', width: 46, height: 38, blocking: true, maxHp: 28, hitPieces: [2, 4], destroyPieces: [8, 10], collision: { kind: 'ellipse', radiusXRatio: 0.45, radiusYRatio: 0.42 } },
  rock: { kind: 'rock', width: 36, height: 28, blocking: true, maxHp: 130, hitPieces: [2, 3], destroyPieces: [6, 8], collision: { kind: 'ellipse', radiusXRatio: 0.46, radiusYRatio: 0.42 } },
  ...
  'ruin-pillar': { kind: 'ruin-pillar', width: 38, height: 44, blocking: true, maxHp: 110, hitPieces: [2, 3], destroyPieces: [6, 8], collision: { kind: 'box', widthRatio: 0.8, heightRatio: 0.8 } },
  barrel: { kind: 'barrel', width: 34, height: 34, blocking: true, maxHp: 45, hitPieces: [3, 4], destroyPieces: [6, 8], collision: { kind: 'box', widthRatio: 0.9, heightRatio: 0.9 } },
  crate: { kind: 'crate', width: 38, height: 38, blocking: true, maxHp: 52, hitPieces: [3, 4], destroyPieces: [6, 8], collision: { kind: 'box', widthRatio: 0.9, heightRatio: 0.9 } },
